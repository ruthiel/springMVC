...
<div class="jumbotron jumbotron-fluid">
	<div class="container">
		...
		<p class="lead">Welcome to this amazing application!!!
		<p>
			...
			<table class="table table-striped table-bordered">
				...
				<c:forEach var="user" items="${userMap}">
					<tr>
						...
						<td>${user.email}</td>
						<td>
							<button><a href="user/remove/${user.username}">Delete</a></button>
						</td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
		<button><a class="btn btn-info" href="logout">Logout</a></button>
	</div>
</div>
